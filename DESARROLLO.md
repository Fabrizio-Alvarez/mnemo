...
- ✅ **Deploy LIVE** (2026-08-26): **https://mnemo.falvarez.dev** — Workers + Neon + dominio propio. Todas las rutas verificadas en producción (dashboard, mazos, estudio, stats, importador). Bug raíz: configuración Prisma+OpenNext (sin output directory, serverExternalPackages correctos, dynamic import de pg en rama Node). Ver CONTEXTO.md §Deploy y §Gotchas.
